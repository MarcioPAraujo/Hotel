...
public class SalvarEdicaoDeReserva extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(reserva.getQuarto().getClassificacao() == null){
                reserva.getQuarto().setClassificacao("D");
            }
            ...
            String message = "reserva atualizada";
